...
class LaserAnalysis(object):
    ...
    def __init__(self, database_dir=None, database_fn=None, patient=None, exp=None, zip_fl=None, mode="normal"):
        ...
        distal_bp_source = str(getattr(self.hints, 'BPDistal', 'blank'))
        ...
        self.bp_distal = DAQContainerLaser(data=getattr(daq_raw, distal_bp_source, daq_raw.blank), sampling_rate=daq_raw.sampling_rate)
    ...
    def process(self):
        ...
        self.results['BP_Distal_MAP_Mean'] = np.mean(self.bp_distal.data[begin:end])
